...
<img src="/assets/images/jvm/image3.png" style="width: 800px;"></img>


加载是类加载过程的第一步，主要完成下面 3 件事情：

1. 通过全类名获取定义此类的二进制字节流
2. 将字节流所代表的静态存储结构转换为方法区(元空间)的运行时数据结构
3. 在内存中生成一个代表该类的 `Class` 对象，作为方法区(元空间)这些数据的访问入口
...
<img src="/assets/images/jvm/image4.png" style="width: 800px;"></img>
...
<img src="/assets/images/jvm/image5.png" style="width: 800px;"></img>
...
- https://tuonioooo-notebook.gitbook.io/performance-optimization/jvmyou-hua-pian/classloaderxiang-jie
